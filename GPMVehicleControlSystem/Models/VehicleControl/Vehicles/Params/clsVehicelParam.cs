...
namespace GPMVehicleControlSystem.Models.VehicleControl.Vehicles.Params
{
    ...
    public class clsVehicelParam
    {
        ...
        public bool HasTrayCstReader { get; set; } = true;
        public bool HasRackCstReader { get; set; } = false;
        ...
        /// 單位:毫秒(ms)
        /// </remarks>
        public int ModuleInfoTopicRevHandlePeriod { get; set; } = 0;
        public int ModuleInfoTopicRevQueueSize { get; set; } = 1;
        ...
        public CST_ID_READ_FAIL_ACTION Cst_ID_Read_Fail_Action { get; set; } = CST_ID_READ_FAIL_ACTION.QUERY_VIRTUAL_ID;
